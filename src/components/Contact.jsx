    ...
    <section id='contact' className='app-container py-16'>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className=''>
          ...
          <h2 className="section-header">Ready to <span className="gradient-text">Transform</span> your business with AI?</h2>
          <p className="section-description">
            Have questions or want to learn more about how AI can benefit your business? Fill out the form and we'll get back to you soon!
          </p>
        ...
        {/*contact form*/}
        <div className='bg-white rounded-xl shadow-lg p-6 lg:8'>
            <form>
              ...
              <button className='btn-primary w-full mt-6 cursor-pointer'>Send Message</button>
            </form>
        </div>
      </div>
    </section>
