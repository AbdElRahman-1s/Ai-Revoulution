...
function AiBenefits() {
  return (
    <section id='benefits' className="app-container py-16 bg-linear-to-br from-dark to-gray-900 rounded-3xl text-white">
      <div className="text-center mb-12">
        <span className="section-subheader">AI Benefits</span>
        <h2 className="section-header">How AI is {" "} <span className="gradient-text">Transforming Our World</span>
        </h2>
